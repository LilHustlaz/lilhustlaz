...
const RareImages = () => {
  let slides = [
    ...
    <img className="carouselimg" src="https://imagedelivery.net/RT_RPMu352DnmQo9WAcrJw/27d99488-adad-451c-89eb-fa698d143900/GIF" width={300} height={300} alt="80s" />,
    <img className="carouselimg" src="https://imagedelivery.net/RT_RPMu352DnmQo9WAcrJw/79c85f7f-3fb1-4bd0-18ed-de106a518000/GIF" width={300} height={300} alt="Robo" />,
    <img className="carouselimg" src="https://imagedelivery.net/RT_RPMu352DnmQo9WAcrJw/782e15fc-260f-4176-8a2d-0ab0671cd600/GIF" width={300} height={300} alt="Frozen" />,
    <img className="carouselimg" src="https://imagedelivery.net/RT_RPMu352DnmQo9WAcrJw/c09bc2c8-d37c-4f43-2cc7-8e95b167ad00/GIF" width={300} height={300} alt="Zuko" />,
  ];
  return (
    <Wrapper>
