...
const AboutUs = () => {
  return (
    <Wrapper>
      ...
      <Text>
        <strong>Lil Hustlaz</strong> is an NFT (Non-Fungible Token) project that brings
        ownership into the 21st century. The project connects the digital and
        physical worlds using NFTs as the medium.
      </Text>
      <Text>
